          ...
          <div className="modal-content">
            ...
            <form ref={formRef} target="/" onSubmit={handleSubmit} >
              <div className="modal-body">
                ...
                {musicInfo.imgSrc && (
              <img src={'/Images/'+musicInfo.imgSrc} alt="Album cover" />
        )}
                ...
                <input type="number" className="form-control" id="year" name="yearRelease" placeholder="YYYY" min="1980" max="2024" value={musicInfo.year} 
